...
public class PotionEffectsAdapter implements JsonSerializer<Set<PotionEffect>>, JsonDeserializer<Set<PotionEffect>> {
    ...
    public static final Type TYPE = new TypeToken<Set<PotionEffect>>() {
    }.getType();
     ...
     */
    @Override
    public JsonElement serialize(Set<PotionEffect> src, Type typeOfSrc, JsonSerializationContext context) {
     ...
     */
    @Override
    public Set<PotionEffect> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        for (JsonElement e : array) {
            ...
            if (type == null) {
                WarpsX.getPlugin().getLogger().warning("Unrecognizable potion effect: " + data[0]);
                continue;
            }

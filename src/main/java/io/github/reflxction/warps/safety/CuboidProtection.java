...
public class CuboidProtection implements Cloneable, ConfigurationSerializable, Iterable<Block> {

    protected String worldName;
    protected final Vector minimumPoint, maximumPoint;

    public CuboidProtection(CuboidProtection cuboid) {
    ...
    public CuboidProtection(Location loc) {
        this(loc, loc);
    }

    public CuboidProtection(Location loc1, Location loc2) {
    ...
    public CuboidProtection(String worldName, double x1, double y1, double z1, double x2, double y2, double z2) {
    ...
    public static CuboidProtection deserialize(Map<String, Object> serializedCuboid) {
        try {
            ...
            return new CuboidProtection(worldName, xPos1, yPos1, zPos1, xPos2, yPos2, zPos2);
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
        }
